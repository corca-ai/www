    ...
    testimonials: [
      {
        id: 'kyowon',
        quote: [
          '“Codex 엔터프라이즈 PoC 시작 후 모두가 우왕좌왕할 때 코르카를 만났습니다.',
          '함께 과제를 선정하고 AX 챔피언 육성 컨설팅을 진행하며 참여자들의 집중도가 확 올라가고',
          '챔피언 선별 기준이 잘 잡혔습니다. 효율적으로 AI를 활용하는 방법도 잘 배워서',
          '크레딧 비용에 대한 부담도 줄어들고 생산성이 향상되었습니다."',
        ],
      ...
      },
      {
        id: 'tyche',
        quote: [
          '"당시 세션 참여했던 분들을 필두로 AX가 많이 이뤄지고 있습니다. ‘이렇게 하면 되는구나’를 경험하며 0 → 0.1 이 된 게 아주 컸습니다. 6개월 후인 지금 돌이켜볼 때, 코르카의 AX 가속화 컨설팅을 받지 않았다면 타이키의 AX가 어쩌면 지금까지도 충분히 이뤄지지 않았을 것 같습니다."',
        ],
  ...
  internalProof: {
    ...
    cards: [
      ...
      },
      {
        ...
        body: "챔피언 한두명의 '발표'가 아닌 모두의 실험과 시행착오가 전사의 배움으로 남습니다.",
      },
      {
        cadence: '매일 쓰이는',
        title: 'AX 에이전트',
        lead: '일회성 실험에서 워크플로우 변화로',
        body: '신규입사자 온보딩, 지출 결의, 익명 설문 등 반복 업무를 줄이고 일상 업무를 돕습니다.',
      },
    ],
...
export const axV2Assets = {
  ...
  testimonials: {
    kyowon: {
      webp: '/images/pages/ax/logos/v1/kyowon.webp',
      png: '/images/pages/ax/logos/kyowon.png',
      width: 150,
      height: 60,
    },
    tyche: {
      webp: '/images/pages/ax/logos/v1/tyche.webp',
      png: '/images/pages/ax/logos/tyche.png',
      width: 180,
      height: 60,
    },
  },
