...
export const axContent: Record<Lang, AxContent> = {
  ko: {
    ...
    belief: {
      ...
      proof: {
        ...
        participants: { value: '1,000+', label: 'Corca 프로그램 참여자' },
        completion: {
  ...
  en: {
    brand: {
      homeAriaLabel: 'Back to the top of Corca',
      logoAlt: 'Corca',
      partnerLogoAlt: 'OpenAI Partner Network Select Partner',
      brochureCta: 'Learn more | Brochure',
      brochureAriaLabel: 'Open the Corca brochure in a new tab',
    ...
    hero: {
      ...
      consultationCta: 'Book a consultation',
      exploreCta: 'See how Corca works',
    },
    belief: {
      ...
      proof: {
        ...
        participants: { value: '1,000+', label: 'Participants in Corca programs' },
        completion: {
          value: [
  ...
  ja: {
    brand: {
      homeAriaLabel: 'Corcaの先頭へ戻る',
      logoAlt: 'Corca',
      partnerLogoAlt: 'OpenAI Partner Network Select Partner',
      brochureCta: '詳しく見る | パンフレット',
      brochureAriaLabel: 'Corcaのパンフレットを新しいタブで開く',
    ...
    belief: {
      ...
      proof: {
        ...
        participants: { value: '1,000+', label: 'Corcaプログラム参加者' },
        completion: {
  ...
  zh: {
    brand: {
      homeAriaLabel: '返回Corca页面顶部',
      logoAlt: 'Corca',
      partnerLogoAlt: 'OpenAI Partner Network Select Partner',
      brochureCta: '了解更多 | 宣传册',
      brochureAriaLabel: '在新标签页中打开Corca宣传册',
    ...
    belief: {
      ...
      proofAriaLabel: 'Corca服务成果',
      proof: {
        organizations: { value: '20+', label: '与Corca合作过的组织' },
        participants: { value: '1,000+', label: 'Corca项目参与者' },
        completion: {
